...
class ring_buffer
{
    public:
        ...
        ring_buffer& operator=(ring_buffer const& buffer) noexcept
        {
            if (this == &buff)
                return *this;
        ...
        iterator begin() noexcept { return _ptr.get(); }
        
        iterator end() noexcept { return begin() + buffer_size; }

        const_iterator cbegin() const noexcept { return _ptr.get(); }

        const_iterator cend() const noexcept { return begin() + buffer_size; }
        ...
        explicit operator std::string() const noexcept { return as_string(); }
